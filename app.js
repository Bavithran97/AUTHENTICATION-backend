...
mongoose
  .connect("mongodb+srv://bavithran9214:12345@cluster0.dkdvgbx.mongodb.net/", {
...
app.post("/forgot-password", async (req, res) => {
  ...
  try {
    ...
    if (!oldUser) {
      ...
      const link = `https://backend-w4no.onrender.com/reset-password/${oldUser._id}/${token}`;
      console.log(link);
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
          user: "bavithran9214@gmail.com",
          pass: "uwqcmglkzzpmdcag",
        },
      });

      var mailOptions = {
        from: "bavithran9214@gmail.com",
        to: oldUser.email,
